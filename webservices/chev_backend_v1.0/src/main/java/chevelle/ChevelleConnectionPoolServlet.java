 ...
 * Description: It creates a database connection pooling for ... DB 
 *              based on the currently running environment provided by the ChevEnv
 ...
 *              This servlet must be started always AFTER the ChevEnvServlet
 * Author: D. Grebenisan
...
public class ChevelleConnectionPoolServlet extends HttpServlet 
{
    ...
    public void init() throws ServletException 
    {
        ...
        // p.setUrl("jdbc:sqlserver://server.domain.com:1433;DatabaseName=ABC123");      
        ...
        // p.setUsername("......"); // for the development environment
        // p.setPassword(".........."); // for the development environment
