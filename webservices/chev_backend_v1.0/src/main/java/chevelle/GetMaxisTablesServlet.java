 ...
 * Author: D. Grebenisan
 * History: - Mar ........ - Created
 *          - Mar ........ - Changed the MasterTable_Tmp to main table
...
public class GetMaxisTablesServlet extends HttpServlet {
 ...
 /*       
        try
        {
            ...
            ds = (DataSource)envContext.lookup("jdbc/some_dbcp");
            log("Data source 'some_dbcp' look-up success");
            
            CHEVELLE_ENV = (String) envContext.lookup("CHEVELLE_ENV");
            log("Chevelle environment look-up success: " + CHEVELLE_ENV);
            
            //DataSource ds = (DataSource)initContext.lookup("java:/comp/env/jdbc/jdbc/other_dbcp");
            
            // This code doesn't work unless all parameters are present in the context.xml of the app
            // ds.setUrl("jdbc:sqlserver://server.domain.com:1433;DatabaseName=SomeDB");
            // ds.setUsername(".........");
            // ds.setPassword("................");
